...
export class Migration1771297962265 implements MigrationInterface {
    name = 'Migration1771297962265'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."users_employeestatus_enum" RENAME TO "users_employeestatus_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."users_employeestatus_enum" AS ENUM('Regular', 'Probationary', 'Resigned', 'AWOL')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_employeestatus_enum_old" AS ENUM('Regular', 'Probationary')`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "employeeStatus" DROP DEFAULT`);
